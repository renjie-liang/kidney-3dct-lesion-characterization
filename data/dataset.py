...
class KidneyCTDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        labels.update({
            ...
            "l3_left_mass": l3_left["mass"],
            "l3_left_mass_valid": l3_left["mass_valid"],
            "l3_left_tumor": l3_left["tumor"],
            "l3_left_tumor_valid": l3_left["tumor_valid"],
            ...
            "l3_right_mass": l3_right["mass"],
            "l3_right_mass_valid": l3_right["mass_valid"],
            "l3_right_tumor": l3_right["tumor"],
            "l3_right_tumor_valid": l3_right["tumor_valid"],
        ...
        if self.swap_lr:
            ...
            l3_prefixes = ["exists", "cyst", "cyst_valid", "mass", "mass_valid",
                           "tumor", "tumor_valid", "size", "size_valid",
    ...
    def _parse_lesions(self, lesion_list: list) -> dict:
        ...
        for lesion in sorted_lesions:
            ...
            mass.append(m); mass_v.append(mv)
            t, tv = self._encode_bool(lesion.get("Tumor", "unknown"))
            tumor.append(t); tumor_v.append(tv)
        ...
        mass += [0.0] * pad; mass_v += [0.0] * pad
        tumor += [0.0] * pad; tumor_v += [0.0] * pad
        ...
        return {
            ...
            "mass": mass, "mass_valid": mass_v,
            "tumor": tumor, "tumor_valid": tumor_v,
